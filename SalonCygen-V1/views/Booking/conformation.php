...
$sql="INSERT INTO appoinment(cusId,cusEmail,salonId,service,bookingDate,slotId,employeeId,employeeName) values('$cusId','$cusEmail','$salonId','$service','$bookingDate','$slotId','$employeeId','$employeeName')";
